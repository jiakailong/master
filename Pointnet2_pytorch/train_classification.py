"""
Training script for lung point cloud classification using MSG model
"""
...
def main(args):
    ...
    exp_dir = exp_dir.joinpath('lung_classification_msg')
    exp_dir.mkdir(exist_ok=True)
    ...
    classifier = model.get_model(num_class, normal_channel=args.use_normals, use_intensity=args.use_intensity)
